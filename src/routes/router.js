 ...
 *
 * @param {string|Function} handler - The route handler (string for static pages, function for dynamic handlers).
...
function handleRoute(handler, context, request, params) {
  if (typeof handler === 'string') {
    return context.sendPage(handler)
  }
 ...
 * @param {Object} context - The context object passed to middleware and handlers.
 * @param {Request} request - The incoming HTTP request.
 * @param {Array.<Array.<string|Function>>} routes - The array of route definitions.
